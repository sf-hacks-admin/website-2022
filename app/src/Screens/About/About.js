        ...
        return (
            <div className="about-section">
                <div className="about-banner">
                    ...
                    <div className="about-banner-text-bottom-mac" style={{ transform: `translateY(-${offsetY * 0.1}px)` }}>
                        GOING VIRTUAL
                    </div>
                    <div className="about-banner-text-mobile-mac" style={{ transform: `translateY(-${offsetY * 0.1}px)` }}>
                        GOING VIRTUAL
                    </div>
                </div>
